...
package rhyme.a.is.nine.foodmanager.gui.graph;
...
public class BarGraph extends View implements HoloGraphAnimate {
    ...
    public void animateToGoalValues() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB_MR1){
            Log.e("HoloGraphLibrary error", "Animation not supported on api level 11 and below. Returning without animating.");
            return;
        }
        if (mValueAnimator != null)
            mValueAnimator.cancel();
